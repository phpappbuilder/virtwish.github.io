...
function WebRTCAdaptor(initialValues)
{
	...
	/**
	 * Closes stream, if you want to stopВ peer connection, call stop(streamId)
	 */
	...
	/**
	 * If we have multiple videoВ tracks in coming versions, this method may cause some issues
	 */
